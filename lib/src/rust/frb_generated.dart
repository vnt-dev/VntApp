...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 96320980;
...
abstract class RustLibApi extends BaseApi {
  VntApiCallback vntApiCallbackNew(
  ...
  RustCurrentDeviceInfo vntApiCurrentDevice(
      {required VntApi that, dynamic hint});

  List<RustPeerClientInfo> vntApiDeviceList(
      {required VntApi that, dynamic hint});

  String vntApiDownStream({required VntApi that, dynamic hint});

  RustNatInfo vntApiNatInfo({required VntApi that, dynamic hint});

  Future<VntApi> vntApiNew(
      {required VntConfig vntConfig,
      required VntApiCallback call,
      dynamic hint});

  RustNatInfo? vntApiPeerNatInfo(
      {required VntApi that, required String ip, dynamic hint});

  RustRoute? vntApiRoute(
      {required VntApi that, required String ip, dynamic hint});

  List<(String, List<RustRoute>)> vntApiRouteList(
      {required VntApi that, dynamic hint});

  Future<void> vntApiStop({required VntApi that, dynamic hint});

  String vntApiUpStream({required VntApi that, dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  VntApiCallback vntApiCallbackNew(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_DartFn_Inputs__Output_unit(successFn, serializer);
        sse_encode_DartFn_Inputs_rust_device_info_Output_unit(
            createTunFn, serializer);
        sse_encode_DartFn_Inputs_rust_connect_info_Output_unit(
            connectFn, serializer);
        sse_encode_DartFn_Inputs_rust_handshake_info_Output_bool(
            handshakeFn, serializer);
        sse_encode_DartFn_Inputs_rust_register_info_Output_bool(
            registerFn, serializer);
        sse_encode_DartFn_Inputs_rust_device_config_Output_u_32(
            generateTunFn, serializer);
        sse_encode_DartFn_Inputs_list_rust_peer_client_info_Output_unit(
            peerClientListFn, serializer);
        sse_encode_DartFn_Inputs_rust_error_info_Output_unit(
            errorFn, serializer);
        sse_encode_DartFn_Inputs__Output_unit(stopFn, serializer);
      ...
      constMeta: kVntApiCallbackNewConstMeta,
      argValues: [
        successFn,
        createTunFn,
        connectFn,
  ...
  TaskConstMeta get kVntApiCallbackNewConstMeta => const TaskConstMeta(
  ...
  RustCurrentDeviceInfo vntApiCurrentDevice(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiCurrentDeviceConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiCurrentDeviceConstMeta => const TaskConstMeta(
  ...
  List<RustPeerClientInfo> vntApiDeviceList(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiDeviceListConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiDeviceListConstMeta => const TaskConstMeta(
  ...
  String vntApiDownStream({required VntApi that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiDownStreamConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiDownStreamConstMeta => const TaskConstMeta(
  ...
  RustNatInfo vntApiNatInfo({required VntApi that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiNatInfoConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiNatInfoConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kVntApiNewConstMeta => const TaskConstMeta(
  ...
  RustNatInfo? vntApiPeerNatInfo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiPeerNatInfoConstMeta,
      argValues: [that, ip],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiPeerNatInfoConstMeta => const TaskConstMeta(
  ...
  RustRoute? vntApiRoute(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiRouteConstMeta,
      argValues: [that, ip],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiRouteConstMeta => const TaskConstMeta(
  ...
  List<(String, List<RustRoute>)> vntApiRouteList(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiRouteListConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiRouteListConstMeta => const TaskConstMeta(
  ...
  Future<void> vntApiStop({required VntApi that, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kVntApiStopConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiStopConstMeta => const TaskConstMeta(
  ...
  String vntApiUpStream({required VntApi that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kVntApiUpStreamConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kVntApiUpStreamConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kVntInitConstMeta => const TaskConstMeta(
        debugName: "vnt_init",
        argNames: ["vntConfig", "call"],
      );
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_list_rust_peer_client_info_Output_unit(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_connect_info_Output_unit(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_device_config_Output_u_32(
    ...
    return (callId, rawArg0) async {
      ...
      final serializer = SseSerializer(generalizedFrbRustBinding);
      sse_encode_u_32(rawOutput, serializer);
      final output = serializer.intoRaw();
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_device_info_Output_unit(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_error_info_Output_unit(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_handshake_info_Output_bool(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_rust_register_info_Output_bool(
  ...
  VntApi
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApi(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return VntApi.dcoDecode(raw as List<dynamic>);
  }
  ...
  VntApiCallback
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApiCallback(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return VntApiCallback.dcoDecode(raw as List<dynamic>);
  }
  ...
  FutureOr<void> Function(List<RustPeerClientInfo>)
      dco_decode_DartFn_Inputs_list_rust_peer_client_info_Output_unit(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<void> Function(RustConnectInfo)
      dco_decode_DartFn_Inputs_rust_connect_info_Output_unit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<int> Function(RustDeviceConfig)
      dco_decode_DartFn_Inputs_rust_device_config_Output_u_32(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<void> Function(RustDeviceInfo)
      dco_decode_DartFn_Inputs_rust_device_info_Output_unit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<void> Function(RustErrorInfo)
      dco_decode_DartFn_Inputs_rust_error_info_Output_unit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<bool> Function(RustHandshakeInfo)
      dco_decode_DartFn_Inputs_rust_handshake_info_Output_bool(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  FutureOr<bool> Function(RustRegisterInfo)
      dco_decode_DartFn_Inputs_rust_register_info_Output_bool(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError('');
  }
  ...
  VntApiCallback
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVntApiCallback(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return VntApiCallback.sseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  RustRoute sse_decode_rust_route(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_isTcp = sse_decode_bool(deserializer);
    ...
    return RustRoute(
        isTcp: var_isTcp, addr: var_addr, metric: var_metric, rt: var_rt);
  }
  ...
  VntConfig sse_decode_vnt_config(SseDeserializer deserializer) {
    ...
    var var_tcp = sse_decode_bool(deserializer);
  ...
  @protected
  void sse_encode_DartFn_Inputs_list_rust_peer_client_info_Output_unit(
      FutureOr<void> Function(List<RustPeerClientInfo>) self,
      SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_list_rust_peer_client_info_Output_unit(self),
        serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_connect_info_Output_unit(
      FutureOr<void> Function(RustConnectInfo) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_connect_info_Output_unit(self), serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_device_config_Output_u_32(
      FutureOr<int> Function(RustDeviceConfig) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_device_config_Output_u_32(self), serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_device_info_Output_unit(
      FutureOr<void> Function(RustDeviceInfo) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_device_info_Output_unit(self), serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_error_info_Output_unit(
      FutureOr<void> Function(RustErrorInfo) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_error_info_Output_unit(self), serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_handshake_info_Output_bool(
      FutureOr<bool> Function(RustHandshakeInfo) self,
      SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_handshake_info_Output_bool(self), serializer);
  }

  @protected
  void sse_encode_DartFn_Inputs_rust_register_info_Output_bool(
      FutureOr<bool> Function(RustRegisterInfo) self,
      SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_rust_register_info_Output_bool(self), serializer);
  }
  ...
  void sse_encode_rust_route(RustRoute self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bool(self.isTcp, serializer);
  ...
  void sse_encode_vnt_config(VntConfig self, SseSerializer serializer) {
    ...
    sse_encode_bool(self.tcp, serializer);
