...
public final class ChangeApplyResult {
    ...
    static ChangeApplyResult fromJson(String json) throws VntException {
        try {
            ...
            throw new VntException("无效的运行期变更结果", error);
        }
    }
    ...
    public boolean isApplied() { return "applied".equals(action); }

    public boolean isNeedFd() { return "need_fd".equals(action); }

    public boolean isRebuild() { return "rebuild".equals(action); }
