...
Future<VntApi> vntInit(
        ...
        dynamic hint}) =>
    RustLib.instance.api.vntInit(vntConfig: vntConfig, call: call, hint: hint);

// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<VntApi>>
@sealed
class VntApi extends RustOpaque {
  VntApi.dcoDecode(List<dynamic> wire) : super.dcoDecode(wire, _kStaticData);

  VntApi.sseDecode(int ptr, int externalSizeOnNative)
  ...
  RustCurrentDeviceInfo currentDevice({dynamic hint}) =>
      RustLib.instance.api.vntApiCurrentDevice(that: this, hint: hint);

  List<RustPeerClientInfo> deviceList({dynamic hint}) =>
      RustLib.instance.api.vntApiDeviceList(that: this, hint: hint);

  String downStream({dynamic hint}) =>
      RustLib.instance.api.vntApiDownStream(that: this, hint: hint);

  RustNatInfo natInfo({dynamic hint}) =>
      RustLib.instance.api.vntApiNatInfo(that: this, hint: hint);
  ...
  static Future<VntApi> newInstance(
      ...
      RustLib.instance.api
          .vntApiNew(vntConfig: vntConfig, call: call, hint: hint);

  RustNatInfo? peerNatInfo({required String ip, dynamic hint}) =>
      RustLib.instance.api.vntApiPeerNatInfo(that: this, ip: ip, hint: hint);

  RustRoute? route({required String ip, dynamic hint}) =>
      RustLib.instance.api.vntApiRoute(that: this, ip: ip, hint: hint);

  List<(String, List<RustRoute>)> routeList({dynamic hint}) =>
      RustLib.instance.api.vntApiRouteList(that: this, hint: hint);

  Future<void> stop({dynamic hint}) =>
      RustLib.instance.api.vntApiStop(that: this, hint: hint);

  String upStream({dynamic hint}) =>
      RustLib.instance.api.vntApiUpStream(that: this, hint: hint);
}
...
class VntApiCallback extends RustOpaque {
  VntApiCallback.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  VntApiCallback.sseDecode(int ptr, int externalSizeOnNative)
      : super.sseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  factory VntApiCallback(
          ...
          dynamic hint}) =>
      RustLib.instance.api.vntApiCallbackNew(
          successFn: successFn,
